...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(540, 150, 101, 51))
        self.pushButton.setObjectName("pushButton")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(100, 130, 71, 31))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(100, 190, 51, 21))
        self.label_2.setObjectName("label_2")
        self.passwordField = QtWidgets.QLineEdit(self.centralwidget)
        self.passwordField.setGeometry(QtCore.QRect(170, 180, 291, 31))
        self.passwordField.setObjectName("passwordField")
        self.userNameField = QtWidgets.QLineEdit(self.centralwidget)
        self.userNameField.setGeometry(QtCore.QRect(170, 130, 291, 31))
